...
from wealthboard.etf.adapters.decorators.cached_owned_etf_repository import CachedOwnedETFRepository
...
# === CACHE ===
owned_etf_cache = CachedOwnedETFRepository(repo_owned)
...
print(use_case_metrics.calculate_std_deviation("EUNL.DE", "01-JAN-2024"))
